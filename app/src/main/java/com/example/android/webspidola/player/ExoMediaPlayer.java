 ...
 */
public class ExoMediaPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
  ...
  private InfoListener infoListener;
	private Uri renderedUri;
  	...
  	public ExoMediaPlayer(RendererBuilder rendererBuilder, Uri uri) {
		this.rendererBuilder = rendererBuilder;
		this.renderedUri = uri;
		player = ExoPlayer.Factory.newInstance(RENDERER_COUNT, 50, 1000);//, 1000, 5000
	...
	public Uri getRenderedUri(){return renderedUri;}
  ...
  public void setInternalErrorListener(InternalErrorListener listener) {internalErrorListener = listener; }
  ...
  public boolean isPlaying(){
    ...
    if(this.getPlaybackState() == ExoPlayer.STATE_READY)
      playing = true;
    return playing;
  }
